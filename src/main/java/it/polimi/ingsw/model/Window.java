    ...
    public Window(String name){
        ...
        switch (name){
            ...
            case "Battlo":
                ...
                pattern[2][1].setColor(Colors.GREEN);
                pattern[2][2].setColor(Colors.YELLOW);
                pattern[2][3].setColor(Colors.PURPLE);
                pattern[2][4].setValue(2);
                pattern[3][0].setValue(1);
                pattern[3][1].setValue(4);
                pattern[3][2].setColor(Colors.RED);
            ...
            case "Fulgor del Cielo":
                ...
                pattern[0][2].setColor(Colors.RED);
                pattern[1][1].setValue(4);
                pattern[1][2].setValue(5);
                pattern[1][4].setColor(Colors.BLUE);
                pattern[2][0].setColor(Colors.BLUE);
                pattern[2][1].setValue(2);
                pattern[2][3].setColor(Colors.RED);
                pattern[2][4].setValue(5);
                pattern[3][0].setValue(6);
                pattern[3][1].setColor(Colors.RED);
            ...
            case "Luz Celestial":
                ...
                pattern[3][1].setColor(Colors.YELLOW);
            ...
            case "Lux Mundi":
                ...
                pattern[1][1].setColor(Colors.GREEN);
                ...
                pattern[2][4].setColor(Colors.GREEN);
                pattern[3][1].setColor(Colors.BLUE);
                pattern[3][2].setValue(5);
                pattern[3][3].setColor(Colors.GREEN);
                break;
            ...
            case "Lux Astram":
                ...
                pattern[0][2].setColor(Colors.GREEN);
                pattern[0][3].setColor(Colors.PURPLE);
                pattern[0][4].setValue(4);
                pattern[1][0].setValue(6);
                pattern[1][1].setColor(Colors.PURPLE);
                pattern[1][2].setValue(2);
                pattern[1][3].setValue(5);
                pattern[1][4].setColor(Colors.GREEN);
                pattern[2][0].setValue(1);
                pattern[2][1].setColor(Colors.GREEN);
                pattern[2][2].setValue(5);
                pattern[2][3].setValue(3);
                pattern[2][4].setColor(Colors.PURPLE);
                break;
